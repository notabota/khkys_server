...
from traffic_object.utils.general import check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
    resample_segments, clean_str
from traffic_object.utils.torch_utils import torch_distributed_zero_first
...
class LoadStreams:  # multiple IP or RTSP cameras
    def __init__(self, sources='streams.txt', img_size=640, stride=32):
        ...
        if os.path.isfile(sources) and sources.endswith('.txt'):  # file
